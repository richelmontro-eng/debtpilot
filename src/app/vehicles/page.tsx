  ...
  return <main className="min-h-screen bg-slate-950 text-slate-100">
    <div className="mx-auto max-w-7xl px-5 py-8">
      ...
      <section className="mt-6 rounded-3xl border border-slate-800 bg-slate-900 p-6">
        ...
        {comparisons.length === 0 ? <p className="mt-5 rounded-2xl border border-dashed border-slate-700 p-5 text-sm text-slate-500">No saved vehicles yet.</p> : <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-3">{comparisons.map(({ vehicle, result: comparison }) => <article key={vehicle.id} className="rounded-2xl border border-slate-800 bg-slate-950/60 p-5">
