...
export default function PilotPage() {
  ...
  const review = useMemo(() => {
    ...
    const financialState = { availableBeforeCushion, cushionGap: cushionShortfall, safeExtra, monthlyIncome, payPerCheck, monthlyMinimums, checking, checkingCushion: cushion, strategy, debts, goals: goalModels, billsDueSoon: dueSoon.map(bill => ({ ...bill, dueInDays: bill.frequency === 'weekly' ? 0 : daysUntilDue(bill.dueDay) })), payPeriodsPerYear: schedule.periods };
