        ...
        <nav className="sticky top-0 z-50 border-b border-slate-800 bg-slate-950/95 px-5 py-3 text-slate-100 backdrop-blur">
          <div className="mx-auto flex max-w-7xl items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-sm">
              <Link href="/" className="rounded-lg px-3 py-2 text-slate-300 hover:bg-slate-800 hover:text-white">Dashboard</Link>
              <Link href="/payoff" className="rounded-lg border border-cyan-400/30 px-3 py-2 text-cyan-300 hover:bg-cyan-400/10">Payoff planner</Link>
            </div>
          </div>
        </nav>
        {children}
