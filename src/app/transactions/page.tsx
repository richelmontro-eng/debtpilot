  ...
  return <main className="min-h-screen bg-slate-950 text-slate-100"><div className="mx-auto max-w-7xl px-5 py-8">
    ...
    <section className="mt-6 grid gap-6 xl:grid-cols-[0.85fr_1.15fr]">
      ...
      <div className="rounded-3xl border border-slate-800 bg-slate-900 p-6">
        ...
        <div className="mt-5 space-y-3">{filtered.length === 0 && <p className="rounded-xl border border-dashed border-slate-700 p-5 text-sm text-slate-500">No transactions match this view. Clear the search or type filter, or use the form above to record your first transaction.</p>}{filtered.map(transaction => {
