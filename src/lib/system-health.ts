export const REQUIRED_SCHEMA = {
  ...
  vehicle_scenarios: ['id','user_id','name','price','down_payment','apr','term_months','purchase_date','first_payment_date','preferred_payment_day','registration_annual'],
...
export const MIGRATIONS = [
  ...
  '008_promotional_interest_debts.sql','009_promotional_debt_persistence.sql','010_beta_data_safety.sql','011_bill_occurrences.sql','012_goal_contributions.sql','013_pilot_reconciliation.sql','014_vehicle_timeline_fields.sql',
] as const;

export const LATEST_SCHEMA_VERSION = '014';
...
export function missingMigrations(probes:Probe[]) {
  ...
  if (failed.has('vehicle_scenarios')) missing.push('003_vehicle_scenarios.sql / 014_vehicle_timeline_fields.sql');
