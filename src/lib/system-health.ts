...
export const MIGRATIONS = [
  ...
  '008_promotional_interest_debts.sql','009_promotional_debt_persistence.sql','010_beta_data_safety.sql','011_bill_occurrences.sql',
] as const;

export const LATEST_SCHEMA_VERSION = '011';
