export const REQUIRED_SCHEMA = {
  profiles: ['user_id','display_name','pay_frequency','weekly_take_home','checking_balance','savings_balance','checking_cushion','weekly_living_reserve','onboarding_completed'],
...
export const MIGRATIONS = [
  ...
  '008_promotional_interest_debts.sql','009_promotional_debt_persistence.sql','010_beta_data_safety.sql','011_bill_occurrences.sql','012_goal_contributions.sql',
] as const;

export const LATEST_SCHEMA_VERSION = '012';
