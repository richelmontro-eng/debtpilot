...
export type DashboardDebt = { id: string; name: string; balance: number; apr: number; minimum: number; promotionType?: 'none' | 'zero_percent' | 'deferred_interest'; promotionalApr?: number | null; promotionEndDate?: string | null; postPromotionApr?: number | null; originalPromotionalBalance?: number | null; estimatedDeferredInterest?: number | null };
