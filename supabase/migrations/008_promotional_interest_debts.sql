alter table public.debts
  ...
  add column if not exists promotional_apr numeric(7,3) not null default 0,
...
alter table public.debts add constraint debts_promotional_apr_check check (promotional_apr >= 0);
...
-- Existing "Users manage own debts" RLS policy continues to protect these columns.
